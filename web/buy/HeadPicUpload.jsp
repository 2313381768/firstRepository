...
<body>
	...
	<div class="resume_con">
		...
		<div class="user_operate">
			<ul style="float: left">
			  <li> <a href="userBaseInfo.jsp">我的简历</a></li>
			</ul>
			<div class="clear"></div>
		</div>
		<!--主体部分-->
		<div class="resume_main">
			...
			<div class="resume_left">
				...
				<div class="all_resume">
					<!--------------------- 简历照片修改------------------------->
					<form action="UserPicUploadServlet" method="post"
						enctype="multipart/form-data" onsubmit="return validate();">
						<div class="table_style" style="margin-left: 150px;">
							<div class="uploade" style="background-color: white;border: none">
								<div align="center">
									<img src="../images/profile_pic.png" width="150" height="150" style="width: 150px;height: 150px">
									<p>&nbsp;</p>
